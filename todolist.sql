...
CREATE TABLE `checked_by` (
  ...
  KEY `task_id` (`task_id`),
  CONSTRAINT `checked_by_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`id`),
  CONSTRAINT `checked_by_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `members` (
  ...
  KEY `list_id` (`list_id`),
  CONSTRAINT `members_ibfk_2` FOREIGN KEY (`list_id`) REFERENCES `lists` (`id`),
...
CREATE TABLE `messages` (
  ...
  KEY `list_id` (`list_id`),
  CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`list_id`) REFERENCES `lists` (`id`),
...
-- Dump completed on 2015-03-17 13:36:11
